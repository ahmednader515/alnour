        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-8 items-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              <span>أ/مصطفي المهيلي</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8">
            الرياضيات أسهل مع مستر مصطفي
            </p>
            ...
            {[
              {
                ...
                testimonial: "تجربة رائعة مع منصة أ/مصطفي المهيلي، المحتوى غني والشرح مبسط"
              },
              {
                name: "سيف طارق",
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground">أفضل منصة متخصصة لكورسات الرياضيات</p>
            </motion.div>
